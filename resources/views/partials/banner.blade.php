    ...
    <div class="relative w-full max-w-4xl h-[80vh] bg-opacity-80 rounded-lg overflow-hidden">
        ...
        <div class="swiper mySwiper relative h-full w-full z-10">
            <div class="swiper-wrapper">
                ...
                <!-- Slide 4 -->
                <div class="swiper-slide flex items-center justify-center bg-transparent">
                    <a href="{{ route('banner.close') }}" class="absolute top-4 right-4 pt-[6px] bg-white text-black text-xl rounded-full w-10 h-10 flex items-center justify-center shadow-lg hover:bg-red-500 hover:text-white transition" id="" >
                        ✕
                    </a>
