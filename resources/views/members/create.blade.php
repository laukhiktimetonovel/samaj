        ...
        <div class="bg-white shadow p-4 rounded-[12px] mt-6 p-8">
            <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="full_name" value="{{ old('full_name') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- મોબાઈલ નંબર -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">મોબાઈલ નંબર:</label>
                    <input type="text" name="mobile" value="{{ old('mobile') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- જન્મ તારીખ -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">જન્મ તારીખ:</label>
                    <input type="date" name="birth_date" value="{{ old('birth_date') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- હાલના રહેઠાણનું સરનામું -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">હાલના રહેઠાણનું સરનામું:</label>
                    <input type="text" name="current_address" value="{{ old('current_address') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="gam_other" name="gam_other"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="village_address" value="{{ old('village_address') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- વ્યવસાય -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">વ્યવસાય નું નામ:</label>
                    <input type="text" name="business_name" value="{{ old('business_name') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- વ્યવસાય સરનામું -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">વ્યવસાય સરનામું:</label>
                    <input type="text" name="business_address" value="{{ old('business_address') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- અભ્યાસ -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">અભ્યાસ:</label>
                    <input type="text" name="education" value="{{ old('education') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>
                    ...
                    <div class="flex space-x-4">
                        @foreach(['પુરુષ', 'સ્ત્રી', 'અન્ય'] as $gender)
                            <label class="flex items-center">
                                <input type="radio" name="gender" value="{{ $gender }}" {{ old('gender') == $gender ? 'checked' : '' }} class="h-4 w-4 text-blue-600">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="mosal_name" value="{{ old('mosal_name') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- મોસાળ ની સાખ -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">મોસાળની સાખ:</label>
                    <input type="text" name="mosal_branch" value="{{ old('mosal_branch') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>

                <!-- મોસાળ નું ગામ -->
                <div class="mb-5">
                    <label class="block text-[16px] font-medium text-[#B3541E] mb-1">મોસાળના ગામ નું નામ:</label>
                    <input type="text" name="mosal_village" value="{{ old('mosal_village') }}" class="w-full border border-gray-300 rounded-md px-4 py-2">
                </div>


                <!-- Save Button -->
                <div class="mt-6">
                    <button type="submit" class="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition duration-200">Save</button>
                </div>
            </form>
        </div>
    </div>
