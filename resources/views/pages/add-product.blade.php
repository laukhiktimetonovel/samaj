        ...
        <div class="max-w-xl space-y-4">
            <form action="" method="GET" class="space-y-4 max-w-lg">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="" placeholder=" તમારુ નામ દાખલ કરો" class="w-full px-5 py-3 border border-gray-300 rounded-[12px] focus:outline-none focus:ring-1 focus:ring-[#B3541E]" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="number" value="" placeholder="તમારો મોબાઈલ નંબર દાખલ કરો " class="w-full px-5 py-3 border border-gray-300 rounded-[12px] focus:outline-none focus:ring-1 focus:ring-[#B3541E]" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="address" value="" placeholder="તમારુ નામ સરનામું કરો" class="w-full px-5 py-3 border border-gray-300 rounded-[12px] focus:outline-none focus:ring-1 focus:ring-[#B3541E]" />
                </div>
                ...
                <div id="product-container" class="space-y-4">
                    ...
                    <span class="block mb-2 text-sm font-semibold text-gray-700">(નોંધ -: પાક પસંદ કરો લિસ્ટ માં ના આવે તો નવો પાક ઉમેરો બટન દબાવી પાક ઉમેરવો)</span>
                    <div class="product-row flex flex-col gap-3 items-end">
                        <div class="select-container w-full">
                            <select name="product[]" class="select-option w-full px-5 py-3 border border-gray-300 rounded-[12px] focus:outline-none focus:ring-1 focus:ring-[#B3541E]" >
                ...
                <div class="button-group flex gap-3">
                    ...
                    <button type="button" onclick="addOtherProduct(this)" class="bg-[#B3541E] text-white px-5 py-2 rounded-[12px] transition cursor-pointer" >
                        નવો પાક ઉમેરો 
                    </button>
                </div>
    ...
    <script>
        ...
        function addOtherProduct(button) {
            ...
            input.innerHTML = `
                ...
                <input type="text" name="other_product[]" placeholder="Enter નવો પાક" class="w-full px-5 py-3 border border-gray-300 rounded-[12px] focus:outline-none focus:ring-1 focus:ring-[#B3541E]" />
            `;
