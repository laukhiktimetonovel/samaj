            ...
            <form action="{{ route('family.profile.updateMain') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <div class="mt-4">
                        <img id="photoPreview" src="{{ $parent->photo_url ?? '' }}" alt="Photo Preview"
                            class="{{ $parent->photo_url ? '' : 'hidden' }} w-32 h-32 object-cover rounded-md border border-gray-400">
                    </div>
                    @error('photo')
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="gam_other" name="gam_other" value="{{ old('gam_other') }}"
                        class="w-full border border-gray-400 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 hidden mt-2"
